document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateWidget() {
        ...
        let periodText = '';
        if (match.period === 'Final') {
            periodText = ' (Final)';
        } else if (match.period && match.period.startsWith('Final OT')) {
            periodText = ` (${match.period})`;
        } else if (match.period === 'Final SO') {
            periodText = ' (Final SO)';
        } else if (match.period && match.period.startsWith('OT')) {
            periodText = ` (${match.period})`;
        } else if (match.period === 'SO') {
            periodText = ' (SO)';
        } else if (match.period && match.period.startsWith('Final')) {
            periodText = ` (${match.period})`;
        } else {
